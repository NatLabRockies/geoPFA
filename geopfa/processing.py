...
class Cleaners:
    ...
    def convert_z_measurements(gdf, z_meas, target_z_meas):
        ...
        if not isinstance(z_meas, str) or not isinstance(target_z_meas, str):
            raise ValueError("Z measurement references must be strings.")  # noqa: TRY004
...
class Processing:
    ...
    def point_density(
        ...
        cell_size : float
            ...
            For EPSG:3857, typical values are 50 meters for high detail,
            100 meters for moderate detail, and 500 to 1,000 meters for lower
            detail.
        nx : int
